...
c
     ...
     &             str_avg,dip_avg,rak_avg,prob,rms_diff)
      ...
      real norm1_avg(3),norm2_avg(3),slipol,rms_diff(2,5),rot_angle
...
c normal vectors and the normal vectors of each mechanism
      ...
      do 80 i=1,nfault
        ...
        rot_angle=0.
        call MECH_ROT(norm1_avg,temp1,norm2_avg,temp2,rot_angle)
...
c minimum focal mechanism rotation
      ...
      do 50 i=2,nf
        ...
        rot_angle=0.
        call MECH_ROT(ref1,temp1,ref2,temp2,rot_angle)
        do j=1,3
